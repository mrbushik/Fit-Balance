    ...
    <div className="container refund__container">
      ...
      <div>
        ...
        <ul className="header__privacy-list">
          <li>
            <u className="list__privacy-title"> Device information</u>
          </li>
        </ul>
      ...
      <div>
        <ul className="header__privacy-list">
          <li>
            <u className="list__privacy-title">Order information</u>
          </li>
        </ul>
        <ul className="privacy-list">
          <li>
      ...
      <div>
        <ul className="header__privacy-list">
          <li>
            <u className="list__privacy-title">Customer support information</u>
          </li>
        </ul>
        <ul className="privacy-list">
          <li>
      ...
      <div>
        <h4 className="refund__title">Sharing Personal Information</h4>
        <span>
      ...
      <div>
        <h4 className="refund__title">Behavioural Advertising</h4>
        <span>
        ...
        <ul className="header__privacy-list">
          ...
          <li>
            We use Facebook Pixels in order to track your behaviour to optimise
            our target advertising. We share information about your use of the
            Site, your purchases, and your interaction with our ads on other
            websites with our advertising partners. We collect and share some of
            this information directly with our advertising partners, and in some
            cases through the use of cookies or other similar technologies
            (which you may consent to, depending on your location). You can read
            more about how Meta uses your Personal Information here:
          ...
          <li>
            We use TikTok Pixels in order to track your behaviour to optimise
            our target advertising. We share information about your use of the
            Site, your purchases, and your interaction with our ads on other
            websites with our advertising partners. We collect and share some of
            this information directly with our advertising partners, and in some
            cases through the use of cookies or other similar technologies
            (which you may consent to, depending on your location). You can read
            more about how TikTok uses your Personal Information here:
            <a href="https://ads.tiktok.com/i18n/official/policy/privacy">
              https://ads.tiktok.com/i18n/official/policy/privacy
            </a>
          </li>
        </ul>
        <span className="privacy__paragraph">
        ...
        <ul className="header__privacy-list">
          ...
          <li>
            GOOGLE -<a href="">https://www.google.com/settings/ads/anonymous</a>
          </li>
          <li>
            BING -
      ...
      <div>
        <h4 className="refund__title">Using Personal Information</h4>
        <span>
      ...
      <div>
        <h4 className="refund__title">Lawful basis</h4>
        <span>
      ...
      <div>
        <h4 className="refund__title">Retention</h4>
        <span>
      ...
      <div>
        <h4 className="refund__title">Automatic decision-making</h4>
        <p>
      ...
      <div>
        <h4 className="refund__title">Your rights</h4>
        <h4 className="refund__title refund__mini-title">GDPR</h4>
        <p>
        ...
        <h4 className="refund__title refund__mini-title">CCPA</h4>
        <p>
      ...
      <div>
        <h4 className="refund__title refund__mini-title">Cookies</h4>
        <p>
